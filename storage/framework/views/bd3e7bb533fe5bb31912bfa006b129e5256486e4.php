...
<div class="container-fluid d-flex justify-content-center align-items-center w-50">
    <form action="<?php echo e(route('guestQualification.store', $position->id)); ?>" method="post" class="w-75">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\job_application\resources\views/qualification/create.blade.php ENDPATH**/ ?>